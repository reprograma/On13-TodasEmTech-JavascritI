// 1. faça uma função, que receba dois parametros, e que realize a subtração deles
...
function multiplo(num){
    if(num %5 == 0 && num %7 == 0){
       return  console.log('${num} é multiplo de 5 ou 7');
     }else {
        console.log('${num)não é multiplo de 5 ou 7');
   }    
}
multiplo(35);
multiplo(56);
